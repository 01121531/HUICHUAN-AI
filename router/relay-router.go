...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.DatasetCapture(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.DatasetCapture())
	...
	relayGeminiRouter.Use(middleware.DatasetCapture())
