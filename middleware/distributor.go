...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.HUICHUANError {
	...
	key, index, huichuanError := channel.GetNextEnabledKey()
