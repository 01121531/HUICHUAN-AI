# HUICHUAN Electron Desktop App

This directory contains the Electron wrapper for HUICHUAN, providing a native desktop application with system tray support for Windows, macOS, and Linux.
...
```bash
# If you have a pre-built binary (e.g., huichuan-macos)
cp ../huichuan-macos ../huichuan
```
...
- Store database in `../data/huichuan.db`
...
### Database Location
- **Development**: `../data/huichuan.db` (project directory)
- **Production**:
  - macOS: `~/Library/Application Support/HUICHUAN/data/`
  - Windows: `%APPDATA%/HUICHUAN/data/`
  - Linux: `~/.config/HUICHUAN/data/`
