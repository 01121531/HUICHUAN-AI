...
func ClaudeHelper(c *gin.Context, info *relaycommon.RelayInfo) (huichuanError *types.HUICHUANError) {
	...
	if !model_setting.GetGlobalSettings().PassThroughRequestEnabled &&
		...
		usage, huichuanErr := chatCompletionsViaResponses(c, info, adaptor, openAIRequest)
		if huichuanErr != nil {
			return huichuanErr
		}
