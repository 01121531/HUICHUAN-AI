...
func TestGeminiResponsesHandlerReturnsOpenAIResponsesJSON(t *testing.T) {
	...
	usage, huichuanError := GeminiResponsesHandler(c, info, &http.Response{
		Body: io.NopCloser(bytes.NewReader(body)),
	})
	require.Nil(t, huichuanError)
...
func TestGeminiResponsesHandlerClosesBodyOnReadError(t *testing.T) {
	...
	usage, huichuanError := GeminiResponsesHandler(c, newGeminiResponsesRelayInfo(false), &http.Response{Body: body})
...
func TestGeminiResponsesStreamHandlerReturnsOpenAIResponsesSSE(t *testing.T) {
	...
	usage, huichuanError := GeminiResponsesStreamHandler(c, info, &http.Response{
