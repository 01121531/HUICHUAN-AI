...
import (
	...
	"github.com/01121531/HUICHUAN-AI/relay/channel/task/taskcommon"
...
func ResolveOriginTask(c *gin.Context, info *relaycommon.RelayInfo) *dto.TaskError {
	...
	if originTask.ChannelId != info.ChannelId {
		key, _, huichuanError := ch.GetNextEnabledKey()
		if huichuanError != nil {
			return service.TaskErrorWrapper(huichuanError, "channel_no_available_key", huichuanError.StatusCode)
		}
...
func RelayTaskSubmit(c *gin.Context, info *relaycommon.RelayInfo) (*TaskSubmitResult, *dto.TaskError) {
	...
	c.Header("X-HUICHUAN-Other-Ratios", string(ratiosJSON))
