...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-huichuan-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-huichuan-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-huichuan-container') return true;
      return (
