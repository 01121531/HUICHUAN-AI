...
func HasCSAMViolationMarker(err *types.HUICHUANError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.HUICHUANError) *types.HUICHUANError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.HUICHUANError) *types.HUICHUANError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.HUICHUANError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.HUICHUANError) bool {
