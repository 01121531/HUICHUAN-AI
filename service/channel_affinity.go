...
import (
	...
	"github.com/01121531/HUICHUAN-AI/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "huichuan:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "huichuan:channel_affinity_usage_cache_stats:v1"
)
