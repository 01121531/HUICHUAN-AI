...
// 任一步骤失败时原子回滚已完成的步骤。
func (s *BillingSession) preConsume(c *gin.Context, quota int) *types.HUICHUANError {
...
func NewBillingSession(c *gin.Context, relayInfo *relaycommon.RelayInfo, preConsumedQuota int) (*BillingSession, *types.HUICHUANError) {
	if relayInfo == nil {
	...
	// 钱包路径需要先检查用户额度
	tryWallet := func() (*BillingSession, *types.HUICHUANError) {
	...
	trySubscription := func() (*BillingSession, *types.HUICHUANError) {
